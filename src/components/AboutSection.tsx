      ...
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 mb-6">
            ...
            <span className="text-lavender-dark font-medium">About the Developers</span>
          </div>
          
          <h2 className="font-serif text-2xl md:text-3xl font-bold text-foreground mb-6">
            Built with <Heart className="inline-block w-8 h-8 text-rose fill-rose animate-heartbeat" /> by Level e¹˙⁰⁹⁸⁷
          </h2>
          ...
          <div className="bg-card rounded-3xl p-8 md:p-12 shadow-card">
            ...
            <p className="text-lg text-foreground leading-relaxed mb-6">
              ...
              <span className="font-semibold text-lavender-dark">The Group Who Must Not Be Named</span>{" "}
              with the vision of creating a safe, respectful, and meaningful dating experience exclusively for our campus.
            </p>
            
            <p className="text-lg text-foreground leading-relaxed mb-8">
              This platform is made{" "}
              <span className="text-gradient font-semibold">for students, by students</span>.
            </p>
